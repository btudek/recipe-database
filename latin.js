...
const recipes = [
  { title: 'Peruvian Ceviche', slug: 'ceviche', description: 'Fresh fish marinade', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
  { title: 'Argentine Empanadas', slug: 'empanadas', description: 'Stuffed pastries', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
];
...
const RECIPES = {
  'ceviche': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Cut fish into cubes.', michelinNote: 'The prep.' },
      { stepNumber: 2, instruction: 'Marinate in lime juice.', michelinNote: 'The key.' },
      { stepNumber: 3, instruction: 'Add onions and cilantro.', michelinNote: 'The finish.' },
    ]
  },
};
