...
const recipes = [
  { title: 'Beef Tacos', slug: 'beef-tacos', description: 'Mexican beef tacos', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
  { title: 'Chicken Tacos', slug: 'chicken-tacos', description: 'Mexican chicken tacos', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
  { title: 'Carnitas', slug: 'carnitas', description: 'Mexican pulled pork', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
];
...
const RECIPES = {
  'beef-tacos': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Brown the beef with spices.', michelinNote: 'The meat.' },
      { stepNumber: 2, instruction: 'Warm tortillas.', michelinNote: 'The base.' },
      { stepNumber: 3, instruction: 'Fill with beef, top with onion and cilantro.', michelinNote: 'The toppings.' },
    ]
  },
};
