...
const recipes = [
  { title: 'Chicken Shawarma', slug: 'chicken-shawarma', description: 'Middle Eastern spiced chicken', cuisine_id: '2f76ffd5-3152-4ed6-bb2a-5d4b1c09b07b' },
  { title: 'Beef Shawarma', slug: 'beef-shawarma', description: 'Middle Eastern spiced beef', cuisine_id: '2f76ffd5-3152-4ed6-bb2a-5d4b1c09b07b' },
];
...
const RECIPES = {
  'chicken-shawarma': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Marinate chicken in yogurt and spices overnight.', michelinNote: 'The key.' },
      { stepNumber: 2, instruction: 'Grill or pan-fry until charred.', michelinNote: 'The flavor.' },
      { stepNumber: 3, instruction: 'Slice thin, serve in pita.', michelinNote: 'With tahini.' },
    ]
  },
};
