...
const recipes = [
  { title: 'Chicken Biryani', slug: 'chicken-biryani', description: 'Aromatic rice dish', cuisine_id: 'fec72a8d-e056-400b-8370-f915b936317a' },
  { title: 'Lamb Biryani', slug: 'lamb-biryani', description: 'Lamb aromatic rice', cuisine_id: 'fec72a8d-e056-400b-8370-f915b936317a' },
];
...
const RECIPES = {
  'chicken-biryani': {
    ...
    steps: [
      ...
      { stepNumber: 2, instruction: 'Layer rice and chicken.', michelinNote: 'The layering.' },
      { stepNumber: 3, instruction: 'Cook on low heat.', michelinNote: 'The dum cooking.' },
    ]
  },
};
