...
const recipes = [
  { title: 'Mexican Pozole Rojo', slug: 'pozole-rojo', description: 'Red pozole', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
  { title: 'Mexican Menudo', slug: 'menudo', description: 'Beef tripe soup', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
];

const RECIPES = {
  'pozole-rojo': {
    ingredients: [
      { name: 'Pork hominy', quantity: 800, unit: 'g' },
      { name: 'Dried guajillo chilies', quantity: 6, unit: 'pcs' },
      { name: 'Pork shoulder', quantity: 500, unit: 'g' },
    ],
    steps: [
      { stepNumber: 1, instruction: 'Boil pork with chilies.', michelinNote: 'The broth.' },
      { stepNumber: 2, instruction: 'Shred meat and add hominy.', michelinNote: 'The assembly.' },
      { stepNumber: 3, instruction: 'Serve with toppings.', michelinNote: 'The finish.' },
    ]
  },
};
