...
const recipes = [
  { title: 'Thai Tom Yum', slug: 'thai-tom-yum', description: 'Hot and sour soup', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Thai Tom Kha', slug: 'thai-tom-kha', description: 'Coconut soup', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
];
...
const RECIPES = {
  'thai-tom-yum': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Simmer broth with aromatics.', michelinNote: 'The base.' },
      { stepNumber: 2, instruction: 'Add mushrooms and shrimp.', michelinNote: 'The cooking.' },
      { stepNumber: 3, instruction: 'Season with lime and chili.', michelinNote: 'The finish.' },
    ]
  },
};
