...
const recipes = [
  { title: 'Japanese Okonomiyaki', slug: 'okonomiyaki-2', description: 'Savory pancake', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Japanese Takoyaki', slug: 'takoyaki', description: 'Octopus balls', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
];
...
const RECIPES = {
  'okonomiyaki-2': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Mix cabbage, egg and flour.', michelinNote: 'The batter.' },
      { stepNumber: 2, instruction: 'Cook like a pancake.', michelinNote: 'The cooking.' },
      { stepNumber: 3, instruction: 'Top with sauce and mayo.', michelinNote: 'The finish.' },
    ]
  },
};
