...
const FOOD_PHOTOS: Record<string, string> = {
  ...
  'french-onion-soup': 'https://images.unsplash.com/photo-1594041680534-e8c8cdebd659?w=800',
...
const KEYWORD_RULES = [
  ...
  { keywords: ['soup', 'french-onion'], photo: 'https://images.unsplash.com/photo-1594041680534-e8c8cdebd659?w=800' },
