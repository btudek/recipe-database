...
const recipes = [
  { title: 'Japanese Ramen', slug: 'japanese-ramen', description: 'Japanese noodle soup', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Japanese Udon', slug: 'japanese-udon', description: 'Thick noodle soup', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
];
...
const RECIPES = {
  'japanese-ramen': {
    ingredients: [
      ...
      { name: 'Pork broth', quantity: 800, unit: 'ml' },
      { name: 'Chashu pork', quantity: 150, unit: 'g' },
    ],
    steps: [
      { stepNumber: 1, instruction: 'Prepare broth.', michelinNote: 'The base.' },
      { stepNumber: 2, instruction: 'Cook noodles.', michelinNote: 'The noodles.' },
      { stepNumber: 3, instruction: 'Top with toppings.', michelinNote: 'The serving.' },
    ]
  },
};
