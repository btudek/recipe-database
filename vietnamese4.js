...
const recipes = [
  { title: 'Vietnamese Pho Bo', slug: 'vietnamese-pho-bo', description: 'Beef pho', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Vietnamese Bun Bo Hue', slug: 'bun-bo-hue', description: 'Spicy beef noodle', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
];
...
const RECIPES = {
  'vietnamese-pho-bo': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Simmer bones with spices.', michelinNote: 'The broth.' },
      { stepNumber: 2, instruction: 'Cook noodles.', michelinNote: 'The base.' },
      { stepNumber: 3, instruction: 'Serve with beef slices.', michelinNote: 'The serving.' },
    ]
  },
};
