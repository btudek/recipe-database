...
const recipes = [
  { title: 'Vietnamese Bun Cha', slug: 'bun-cha', description: 'Vietnamese grilled pork', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Vietnamese Cao Lau', slug: 'cao-lau', description: 'Hoi An noodles', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
];
...
const RECIPES = {
  'bun-cha': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Marinate and grill pork.', michelinNote: 'The meat.' },
      { stepNumber: 2, instruction: 'Make dipping sauce.', michelinNote: 'The sauce.' },
      { stepNumber: 3, instruction: 'Serve with noodles.', michelinNote: 'The assembly.' },
    ]
  },
};
