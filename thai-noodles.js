...
const recipes = [
  { title: 'Thai Pad Thai', slug: 'pad-thai-2', description: 'Stir-fried noodles', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Thai Drunken Noodles', slug: 'drunken-noodles-2', description: 'Spicy stir-fry', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
];
...
const RECIPES = {
  'pad-thai-2': {
    ingredients: [
      ...
      { name: 'Tamarind paste', quantity: 60, unit: 'g' },
    ],
    steps: [
      { stepNumber: 1, instruction: 'Soak noodles.', michelinNote: 'The prep.' },
      { stepNumber: 2, instruction: 'Stir-fry protein and eggs.', michelinNote: 'The cooking.' },
      { stepNumber: 3, instruction: 'Add noodles and sauce, toss.', michelinNote: 'The finish.' },
    ]
  },
};
