...
const recipes = [
  ...
  { title: 'Chicken Parmesan', slug: 'chicken-parmesan', description: 'Breaded chicken', cuisine_id: 'f51d9e26-ace3-4b36-9d0c-6364877d3d94' },
];
...
const RECIPES = {
  'shrimp-scampi': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Sauté garlic in butter.', michelinNote: 'The base.' },
      { stepNumber: 2, instruction: 'Cook shrimp until pink.', michelinNote: 'The cooking.' },
    ]
  },
};
