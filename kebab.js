...
const recipes = [
  { title: 'Doner Kebab', slug: 'doner-kebab', description: 'Turkish kebab', cuisine_id: '2f76ffd5-3152-4ed6-bb2a-5d4b1c09b07b' },
  { title: 'Shawarma Plate', slug: 'shawarma-plate', description: 'Middle Eastern plate', cuisine_id: '2f76ffd5-3152-4ed6-bb2a-5d4b1c09b07b' },
];
...
const RECIPES = {
  'doner-kebab': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Stack meat on vertical skewer.', michelinNote: 'The technique.' },
      { stepNumber: 2, instruction: 'Cook slowly, slicing as it browns.', michelinNote: 'The cooking.' },
      { stepNumber: 3, instruction: 'Serve in pita with sauce.', michelinNote: 'The serving.' },
    ]
  },
};
