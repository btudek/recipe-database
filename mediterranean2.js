...
const recipes = [
  { title: 'Greek Moussaka', slug: 'moussaka', description: 'Greek eggplant casserole', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
  { title: 'Spanish Paella', slug: 'paella', description: 'Spanish rice dish', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
];
...
const RECIPES = {
  'moussaka': {
    ingredients: [
      ...
      { name: 'Bechamel sauce', quantity: 300, unit: 'ml' },
    ],
    steps: [
      { stepNumber: 1, instruction: 'Layer eggplant with meat sauce.', michelinNote: 'The layering.' },
      { stepNumber: 2, instruction: 'Top with bechamel.', michelinNote: 'The topping.' },
      { stepNumber: 3, instruction: 'Bake until golden.', michelinNote: 'The baking.' },
    ]
  },
};
