...
const recipes = [
  { title: 'Thai Green Curry', slug: 'thai-green-curry', description: 'Spicy Thai curry', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Thai Red Curry', slug: 'thai-red-curry', description: 'Red Thai curry', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
];
...
const RECIPES = {
  'thai-green-curry': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Fry curry paste in coconut cream.', michelinNote: 'The base.' },
      { stepNumber: 2, instruction: 'Add chicken and vegetables.', michelinNote: 'The cooking.' },
      { stepNumber: 3, instruction: 'Simmer until done.', michelinNote: 'The finish.' },
    ]
  },
};
