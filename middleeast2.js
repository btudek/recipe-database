...
const recipes = [
  { title: 'Turkish Baklava', slug: 'baklava', description: 'Sweet pastry', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
  { title: 'Lebanese Hummus', slug: 'hummus', description: 'Chickpea dip', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
];
...
const RECIPES = {
  'baklava': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Layer nuts between phyllo.', michelinNote: 'The layering.' },
      { stepNumber: 2, instruction: 'Cut and bake.', michelinNote: 'The baking.' },
      { stepNumber: 3, instruction: 'Pour honey syrup.', michelinNote: 'The finish.' },
    ]
  },
};
