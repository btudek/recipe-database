...
const recipes = [
  { title: 'American Cheeseburger', slug: 'classic-cheeseburger', description: 'Beef burger with cheese', cuisine_id: '813587ed-24eb-421d-97be-f5f2d1740e86' },
  { title: 'American Hot Dog', slug: 'classic-hotdog', description: 'Grilled sausage', cuisine_id: '813587ed-24eb-421d-97be-f5f2d1740e86' },
];
...
const RECIPES = {
  'classic-cheeseburger': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Form patties and season.', michelinNote: 'The prep.' },
      { stepNumber: 2, instruction: 'Grill to desired doneness.', michelinNote: 'The cooking.' },
      { stepNumber: 3, instruction: 'Add cheese and assemble.', michelinNote: 'The assembly.' },
    ]
  },
};
