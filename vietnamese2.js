...
const recipes = [
  { title: 'Vietnamese Pho', slug: 'vietnamese-pho', description: 'Vietnamese beef noodle soup', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Banh Mi', slug: 'vietnamese-banh-mi', description: 'Vietnamese sandwich', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Spring Rolls', slug: 'vietnamese-spring-rolls', description: 'Fresh spring rolls', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
];
...
const RECIPES = {
  'vietnamese-pho': {
    ...
    steps: [
      ...
      { stepNumber: 3, instruction: 'Serve with raw beef that cooks in hot broth.', michelinNote: 'The key.' },
    ]
  },
};
