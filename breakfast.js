...
const recipes = [
  { title: 'Eggs Benedict', slug: 'eggs-benedict', description: 'Classic brunch dish', cuisine_id: '813587ed-24eb-421d-97be-f5f2d1740e86' },
  { title: 'Avocado Toast', slug: 'avocado-toast', description: 'Modern breakfast', cuisine_id: '813587ed-24eb-421d-97be-f5f2d1740e86' },
];
...
const RECIPES = {
  'eggs-benedict': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Toast muffins and cook bacon.', michelinNote: 'The prep.' },
      { stepNumber: 2, instruction: 'Poach eggs.', michelinNote: 'The technique.' },
    ]
  },
};
