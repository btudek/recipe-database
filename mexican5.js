...
const recipes = [
  ...
  { title: 'Fish Tacos', slug: 'fish-tacos-mexican', description: 'Mexican fish tacos', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
  { title: 'Al Pastor', slug: 'al-pastor', description: 'Marinated pork tacos', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
];
...
const RECIPES = {
  'shrimp-tacos': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Season and cook shrimp.', michelinNote: 'The shrimp.' },
      { stepNumber: 2, instruction: 'Warm tortillas.', michelinNote: 'The base.' },
      { stepNumber: 3, instruction: 'Fill and serve.', michelinNote: 'The assembly.' },
    ]
  },
};
