...
const recipes = [
  { title: 'Butter Chicken', slug: 'butter-chicken', description: 'Creamy tomato curry', cuisine_id: 'c7c87242-0d7a-4a7a-9e4a-5c3b8d6e1f2a' },
  { title: 'Palak Paneer', slug: 'palak-paneer', description: 'Spinach and cheese curry', cuisine_id: 'c7c87242-0d7a-4a7a-9e4a-5c3b8d6e1f2a' },
];
...
const RECIPES = {
  'butter-chicken': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Cook chicken in spices.', michelinNote: 'The base.' },
      { stepNumber: 2, instruction: 'Add tomato and cream.', michelinNote: 'The sauce.' },
    ]
  },
};
