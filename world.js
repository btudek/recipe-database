...
const recipes = [
  { title: 'Spanish Tortilla', slug: 'spanish-tortilla', description: 'Spanish omelette', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
  { title: 'Brazilian Feijoada', slug: 'feijoada', description: 'Brazilian bean stew', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
];
...
const RECIPES = {
  'spanish-tortilla': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Fry potatoes and onion.', michelinNote: 'The base.' },
      { stepNumber: 2, instruction: 'Mix with eggs.', michelinNote: 'The mixing.' },
      { stepNumber: 3, instruction: 'Cook until set.', michelinNote: 'The cooking.' },
    ]
  },
};
