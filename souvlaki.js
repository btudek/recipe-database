...
const recipes = [
  { title: 'Chicken Souvlaki', slug: 'chicken-souvlaki', description: 'Greek chicken skewers', cuisine_id: '2f76ffd5-3152-4ed6-bb2a-5d4b1c09b07b' },
  { title: 'Pork Souvlaki', slug: 'pork-souvlaki', description: 'Greek pork skewers', cuisine_id: '2f76ffd5-3152-4ed6-bb2a-5d4b1c09b07b' },
];
...
const RECIPES = {
  'chicken-souvlaki': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Marinate chicken in oil, lemon, oregano.', michelinNote: 'The marination.' },
      { stepNumber: 2, instruction: 'Thread onto skewers.', michelinNote: 'The threading.' },
      { stepNumber: 3, instruction: 'Grill until done.', michelinNote: 'The cooking.' },
    ]
  },
};
