...
const recipes = [
  { title: 'Vegetable Lo Mein', slug: 'vegetable-lo-mein', description: 'Stir-fried noodles', cuisine_id: '8232ae82-2fa2-4f95-a9f1-bc7ddd817d28' },
  { title: 'Beef and Broccoli', slug: 'beef-broccoli', description: 'Chinese classic', cuisine_id: '8232ae82-2fa2-4f95-a9f1-bc7ddd817d28' },
];
...
const RECIPES = {
  'vegetable-lo-mein': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Cook noodles.', michelinNote: 'The prep.' },
      { stepNumber: 2, instruction: 'Stir-fry vegetables.', michelinNote: 'The cooking.' },
      { stepNumber: 3, instruction: 'Combine and sauce.', michelinNote: 'The finish.' },
    ]
  },
};
