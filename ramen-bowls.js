...
const recipes = [
  { title: 'Japanese Tonkotsu Ramen', slug: 'tonkotsu-ramen-bowl', description: 'Rich pork bone broth ramen', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Japanese Shoyu Ramen', slug: 'shoyu-ramen-bowl', description: 'Soy sauce based ramen', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
];
...
const RECIPES = {
  'tonkotsu-ramen-bowl': {
    ingredients: [
      ...
      { name: 'Ramen noodles', quantity: 300, unit: 'g' },
      { name: 'Chashu pork', quantity: 200, unit: 'g' },
    ],
    steps: [
      { stepNumber: 1, instruction: 'Boil pork bones for 12 hours.', michelinNote: 'The broth.' },
      { stepNumber: 2, instruction: 'Cook noodles.', michelinNote: 'The base.' },
      { stepNumber: 3, instruction: 'Top with chashu and egg.', michelinNote: 'The serving.' },
    ]
  },
};
