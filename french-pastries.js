...
const recipes = [
  { title: 'French Croissant', slug: 'french-croissant', description: 'Butter pastry', cuisine_id: '2f76ffd5-3152-4ed6-bb2a-5d4b1c09b07b' },
  { title: 'French Baguette', slug: 'french-baguette', description: 'French bread', cuisine_id: '2f76ffd5-3152-4ed6-bb2a-5d4b1c09b07b' },
];
...
const RECIPES = {
  'french-croissant': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Make dough and laminate with butter.', michelinNote: 'The laminating.' },
      { stepNumber: 2, instruction: 'Shape and proof.', michelinNote: 'The shaping.' },
