...
const recipes = [
  { title: 'Korean Sundubu Jjigae', slug: 'sundubu-jjigae', description: 'Spicy tofu stew', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Korean Japchae', slug: 'korean-japchae', description: 'Glass noodle stir fry', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
];
...
const RECIPES = {
  'sundubu-jjigae': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Sauté pork with aromatics.', michelinNote: 'The base.' },
      { stepNumber: 2, instruction: 'Add broth and tofu.', michelinNote: 'The cooking.' },
      { stepNumber: 3, instruction: 'Season with gochujang.', michelinNote: 'The finish.' },
    ]
  },
};
