...
const recipes = [
  { title: 'Mexican Chile Rellenos', slug: 'chile-rellenos', description: 'Stuffed peppers', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
  { title: 'Mexican Elote', slug: 'elote', description: 'Mexican street corn', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
];

const RECIPES = {
  'chile-rellenos': {
    ingredients: [
      { name: 'Poblano peppers', quantity: 6, unit: 'pcs' },
      { name: 'Quesillo cheese', quantity: 300, unit: 'g' },
      { name: 'Eggs', quantity: 4, unit: 'pcs' },
    ],
    steps: [
      { stepNumber: 1, instruction: 'Roast and peel peppers.', michelinNote: 'The prep.' },
      { stepNumber: 2, instruction: 'Stuff with cheese.', michelinNote: 'The filling.' },
      { stepNumber: 3, instruction: 'Egg batter and fry.', michelinNote: 'The cooking.' },
    ]
  },
};
