...
const recipes = [
  { title: 'Italian Panna Cotta', slug: 'panna-cotta-2', description: 'Cream dessert', cuisine_id: 'f51d9e26-ace3-4b36-9d0c-6364877d3d94' },
  { title: 'Italian Tiramisu', slug: 'italian-tiramisu', description: 'Coffee dessert', cuisine_id: 'f51d9e26-ace3-4b36-9d0c-6364877d3d94' },
];
...
const RECIPES = {
  'panna-cotta-2': {
    ingredients: [
      ...
      { name: 'Vanilla', quantity: 1, unit: 'pod' },
      { name: 'Gelatin', quantity: 10, unit: 'g' },
    ],
    steps: [
      { stepNumber: 1, instruction: 'Heat cream with vanilla.', michelinNote: 'The base.' },
      { stepNumber: 2, instruction: 'Add gelatin and chill.', michelinNote: 'The setting.' },
    ]
  },
};
