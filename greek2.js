...
const recipes = [
  { title: 'Greek Moussaka', slug: 'greek-moussaka', description: 'Eggplant casserole', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
  { title: 'Greek Souvlaki', slug: 'greek-souvlaki', description: 'Grilled skewers', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
];
...
const RECIPES = {
  'greek-moussaka': {
    ingredients: [
      ...
      { name: 'Bechamel', quantity: 300, unit: 'ml' },
    ],
    steps: [
      { stepNumber: 1, instruction: 'Slice and salt eggplant.', michelinNote: 'The prep.' },
      { stepNumber: 2, instruction: 'Layer with meat sauce.', michelinNote: 'The assembly.' },
      { stepNumber: 3, instruction: 'Top with bechamel and bake.', michelinNote: 'The baking.' },
    ]
  },
};
