...
const recipes = [
  { title: 'BBQ Pork Ribs', slug: 'bbq-pork-ribs', description: 'American BBQ ribs', cuisine_id: '813587ed-24eb-421d-97be-f5f2d1740e86' },
  { title: 'Baby Back Ribs', slug: 'baby-back-ribs', description: 'Baby back ribs', cuisine_id: '813587ed-24eb-421d-97be-f5f2d1740e86' },
];
...
const RECIPES = {
  'bbq-pork-ribs': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Season ribs with rub.', michelinNote: 'The rub.' },
      { stepNumber: 2, instruction: 'Cook low and slow.', michelinNote: 'The method.' },
      { stepNumber: 3, instruction: 'Glaze with BBQ sauce.', michelinNote: 'The finish.' },
    ]
  },
};
