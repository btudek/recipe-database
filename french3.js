...
const recipes = [
  { title: 'Coq au Vin', slug: 'coq-au-vin', description: 'French chicken in wine', cuisine_id: '2f76ffd5-3152-4ed6-bb2a-5d4b1c09b07b' },
  { title: 'Beef Bourguignon', slug: 'beef-bourguignon', description: 'French beef stew', cuisine_id: '2f76ffd5-3152-4ed6-bb2a-5d4b1c09b07b' },
];
...
const RECIPES = {
  'coq-au-vin': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Marinate chicken in wine.', michelinNote: 'The marination.' },
      { stepNumber: 2, instruction: 'Cook with bacon and mushrooms.', michelinNote: 'The braising.' },
    ]
  },
};
