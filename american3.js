...
const recipes = [
  { title: 'American Mac and Cheese', slug: 'mac-cheese', description: 'Creamy pasta', cuisine_id: '813587ed-24eb-421d-97be-f5f2d1740e86' },
  { title: 'American BBQ Pulled Pork', slug: 'pulled-pork', description: 'Slow cooked pork', cuisine_id: '813587ed-24eb-421d-97be-f5f2d1740e86' },
];
...
const RECIPES = {
  'mac-cheese': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Cook pasta.', michelinNote: 'The base.' },
      { stepNumber: 2, instruction: 'Make cheese sauce.', michelinNote: 'The sauce.' },
      { stepNumber: 3, instruction: 'Combine and bake.', michelinNote: 'The finish.' },
    ]
  },
};
