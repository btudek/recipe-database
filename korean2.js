...
const recipes = [
  { title: 'Korean BBQ', slug: 'korean-bbq', description: 'Korean grilled meat', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Kimchi Fried Rice', slug: 'kimchi-fried-rice', description: 'Korean fried rice', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
];
...
const RECIPES = {
  'korean-bbq': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Marinate beef in soy sauce and sesame.', michelinNote: 'The base.' },
      { stepNumber: 2, instruction: 'Grill or pan-fry.', michelinNote: 'The cooking.' },
      { stepNumber: 3, instruction: 'Serve with rice and lettuce wraps.', michelinNote: 'The serving.' },
    ]
  },
};
