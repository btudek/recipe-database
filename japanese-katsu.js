...
const recipes = [
  { title: 'Japanese Tonkatsu', slug: 'tonkatsu-2', description: 'Crispy pork cutlet', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
  { title: 'Japanese Chicken Katsu', slug: 'chicken-katsu-2', description: 'Chicken cutlet', cuisine_id: 'a3cb4471-db63-434e-a2e2-255242ffaca0' },
];
...
const RECIPES = {
  'tonkatsu-2': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Pound and bread pork.', michelinNote: 'The prep.' },
      { stepNumber: 2, instruction: 'Deep fry until golden.', michelinNote: 'The cooking.' },
      { stepNumber: 3, instruction: 'Serve with shredded cabbage.', michelinNote: 'The finish.' },
    ]
  },
};
