...
const recipes = [
  { title: 'Mexican Churros', slug: 'mexican-churros', description: 'Fried dough', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
  { title: 'Mexican Flan', slug: 'mexican-flan', description: 'Caramel custard', cuisine_id: '539d04d6-e193-4f0f-930a-90553fb21704' },
];
...
const RECIPES = {
  'mexican-churros': {
    ...
    steps: [
      { stepNumber: 1, instruction: 'Make choux dough.', michelinNote: 'The dough.' },
      { stepNumber: 2, instruction: 'Pipe and fry.', michelinNote: 'The cooking.' },
      { stepNumber: 3, instruction: 'Roll in sugar.', michelinNote: 'The finish.' },
    ]
  },
};
